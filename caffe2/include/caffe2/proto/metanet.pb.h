...
class ModelInfo : public ::google::protobuf::Message {
 ...
 private:
  ...
  ::std::string* modelid_;
  friend void  protobuf_AddDesc_caffe2_2fproto_2fmetanet_2eproto();
...
class BlobsMap : public ::google::protobuf::Message {
 public:
  BlobsMap();
  virtual ~BlobsMap();
...
class NetsMap : public ::google::protobuf::Message {
 public:
  NetsMap();
  virtual ~NetsMap();
...
class PlansMap : public ::google::protobuf::Message {
 public:
  PlansMap();
  virtual ~PlansMap();
...
class MetaNetDef : public ::google::protobuf::Message {
 public:
  MetaNetDef();
  virtual ~MetaNetDef();
